...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'custom.company_favicon' => 'NULL',
            'custom.company_gst' => 'string',
            'custom.company_address' => 'string',
            'custom.support_phone' => 'string',
            'custom.support_email' => 'string',
            'custom.theme_color' => 'string',
            'custom.dark_mode' => 'string',
            'custom.homepage_banner' => 'NULL',
            ...
            'filesystems.links.C:\Users\LOGICFOCUS\tc-service-center\public\storage' => 'string',
            ...
            'ide-helper.type_overrides.never' => 'string',
            ...
            'ide-helper.ignored_helpers' => 'array',
...
'auth.guards.web.provider','auth.guards.customer.driver','auth.guards.customer.provider','auth.guards.sanctum.driver','auth.guards.sanctum.provider',
...
'cache.stores.failover.stores','cache.prefix','custom.company_name','custom.company_logo','custom.company_favicon',
'custom.company_gst','custom.company_address','custom.support_phone','custom.support_email','custom.theme_color',
'custom.dark_mode','custom.homepage_banner','database.default','database.connections.sqlite.driver','database.connections.sqlite.url',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\LOGICFOCUS\\tc-service-center\\public\\storage','ide-helper.filename',
...
'ide-helper.type_overrides.boolean','ide-helper.type_overrides.never','ide-helper.include_class_docblocks','ide-helper.force_fqn','ide-helper.use_generics_annotations',
...
'ide-helper.ignored_helpers','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'signed','throttle','verified','admin','technician',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','shop.index','shop.show',
'tracking.index','tracking.show','tracking.updateSpecs','delivery.dashboard','customer.login',
'customer.','customer.register','customer.','customer.password.request','customer.password.email',
'customer.dashboard','customer.logout','customer.notifications.read','customer.invoice.download','customer.service.book',
'customer.service.store','customer.service.custom-build','customer.service.cctv','customer.shop.laptops','customer.product.order',
'customer.orders.index','customer.orders.track','customer.cart.index','customer.cart.add','customer.cart.update',
'customer.cart.remove','customer.cart.checkout','customer.cart.placeOrder','customer.warranty.index','customer.warranty.show',
'customer.warranty.claim','customer.location.save','customer.orders.live-track','customer.settings','customer.learning.index',
'customer.learning.hardware-builder','customer.tech-lab.dashboard','customer.tech-lab.builder','customer.tech-lab.repair','customer.tech-lab.troubleshoot',
'customer.tech-lab.virus-smash','customer.tech-lab.tycoon','customer.tech-lab.scanner','customer.tech-lab.save-score','customer.tech-lab.save-tycoon',
'customer.tech-lab.analyze-device','admin.dashboard','admin.delivery.live-map','admin.services.index','admin.services.create',
'admin.services.store','admin.services.show','admin.services.edit','admin.services.update','admin.services.destroy',
'admin.services.view','admin.services.assignTechnician','admin.services.assignDelivery','admin.services.updateStatus','admin.services.uploadPhotos',
'admin.devices.index','admin.devices.create','admin.devices.store','admin.devices.show','admin.devices.edit',
'admin.devices.update','admin.devices.destroy','admin.parts.index','admin.parts.create','admin.parts.store',
'admin.parts.show','admin.parts.edit','admin.parts.update','admin.parts.destroy','admin.laptops.index',
'admin.laptops.create','admin.laptops.store','admin.laptops.show','admin.laptops.edit','admin.laptops.update',
'admin.laptops.destroy','admin.orders.index','admin.orders.update','admin.warranty.index','admin.inventory.index',
'admin.inventory.updateStock','admin.payments.index','admin.payments.process','admin.invoices.index','admin.invoices.download',
'admin.billings.index','admin.billings.create','admin.billings.store','admin.billings.show','admin.billings.edit',
'admin.billings.update','admin.billings.destroy','admin.purchase-orders.index','admin.purchase-orders.create','admin.purchase-orders.store',
'admin.purchase-orders.show','admin.purchase-orders.edit','admin.purchase-orders.update','admin.purchase-orders.destroy','admin.offers.index',
'admin.offers.create','admin.offers.store','admin.offers.show','admin.offers.edit','admin.offers.update',
'admin.offers.destroy','admin.employees.index','admin.employees.create','admin.employees.store','admin.employees.show',
'admin.employees.edit','admin.employees.update','admin.employees.destroy','admin.attendance.index','admin.attendance.sync',
'admin.attendance.clear','admin.delivery-partners.index','admin.delivery-partners.create','admin.delivery-partners.store','admin.delivery-partners.show',
'admin.delivery-partners.edit','admin.delivery-partners.update','admin.delivery-partners.destroy','admin.warranty.claims','admin.warranty.claims.show',
'admin.warranty.claims.update','admin.warranty.certificates','admin.warranty.certificates.store','admin.finance.dashboard','admin.finance.expenses',
'admin.finance.expenses.store','admin.finance.expenses.destroy','admin.finance.reports','admin.crm.index','admin.crm.show',
'admin.crm.followup','admin.analytics.index','admin.analytics.data','admin.branches.index','admin.branches.create',
'admin.branches.store','admin.branches.show','admin.branches.edit','admin.branches.update','admin.branches.destroy',
'admin.marketing.index','admin.marketing.create','admin.marketing.store','admin.marketing.edit','admin.marketing.update',
'admin.marketing.destroy','admin.marketing.toggle','admin.hrm.payroll','admin.hrm.payroll.generate','admin.hrm.payroll.pay',
'admin.ai.index','admin.ai.diagnose','admin.ai.inventory.forecast','admin.customization.index','admin.customization.settings',
'admin.customization.toggles','admin.notifications.index','admin.notifications.edit','admin.notifications.update','admin.notifications.toggle',
'admin.forms.index','admin.forms.store','admin.forms.show','admin.forms.destroy','admin.forms.addField',
'admin.forms.destroyField','admin.roles.index','admin.roles.store','admin.roles.update','admin.roles.destroy',
'admin.pages.index','admin.pages.create','admin.pages.store','admin.pages.edit','admin.pages.update',
'admin.pages.destroy','technician.dashboard','technician.services.updateStatus','technician.services.photos.store','technician.services.photos.destroy',
'login','password.request','password.email','logout',
'storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'admin.ai.index','admin.analytics.dashboard','admin.attendance.index','admin.billings.create','admin.billings.edit',
'admin.billings.index','admin.branches.create','admin.branches.edit','admin.branches.index','admin.crm.index',
'admin.crm.show','admin.customization.forms.index','admin.customization.forms.show','admin.customization.index','admin.customization.notifications.edit',
'admin.customization.notifications.index','admin.customization.pages.create','admin.customization.pages.edit','admin.customization.pages.index','admin.customization.roles.index',
'admin.dashboard','admin.delivery.live_map','admin.delivery_partners.create','admin.delivery_partners.edit','admin.delivery_partners.index',
'admin.devices.edit','admin.devices.index','admin.devices.show','admin.employees.create','admin.employees.edit',
'admin.employees.index','admin.finance.dashboard','admin.finance.expenses','admin.finance.reports','admin.hrm.payroll',
'admin.inventory.index','admin.invoices.index','admin.invoices.template','admin.laptops.create','admin.laptops.edit',
'admin.laptops.index','admin.marketing.create','admin.marketing.edit','admin.marketing.index','admin.offers.create',
'admin.offers.edit','admin.offers.index','admin.orders.index','admin.payments.checkout','admin.payments.index',
'admin.purchase_orders.create','admin.purchase_orders.edit','admin.purchase_orders.index','admin.services.create','admin.services.index',
'admin.services.show','admin.services.view','admin.stock.create','admin.stock.edit','admin.stock.index',
'admin.technicians.create','admin.technicians.edit','admin.technicians.index','admin.warranty.claims','admin.warranty.index',
'auth.forgot-password','auth.login','components.cyber-sidebar','customer.auth.forgot-password','customer.auth.login',
'customer.auth.register','customer.cart.checkout','customer.cart.index','customer.dashboard','customer.invoice',
'customer.learning.builder3d','customer.learning.byte_scanner','customer.learning.game','customer.learning.index','customer.learning.lab_dashboard',
'customer.learning.repair_sim','customer.learning.repair_tycoon','customer.learning.troubleshoot','customer.learning.virus_smash','customer.orders.index',
'customer.orders.track','customer.partials.location-picker','customer.profile','customer.service.book','customer.service.cctv',
'customer.service.custom-build','customer.settings.index','customer.shop.laptops','customer.support','customer.tracking.live',
'customer.warranty.index','customer.warranty.show','delivery.dashboard','errors.401','errors.402',
'errors.403','errors.404','errors.419','errors.429','errors.500',
'errors.503','errors.layout','errors.minimal','inventory.index','layouts.admin',
'layouts.customer','layouts.dashboard','layouts.technician','notifications::email','pagination::bootstrap-4',
...
'pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','shop.index','shop.show',
'technician.dashboard','track','tracking.index','tracking.show','tracking.status',
...
'C:.Users.LOGICFOCUS.tc-service-center.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'CACHE_STORE','SESSION_DRIVER','SESSION_LIFETIME','QUEUE_CONNECTION','FILESYSTEM_DISK',
'MAIL_MAILER','MAIL_HOST','MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD',
'MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','SANCTUM_STATEFUL_DOMAINS','SESSION_DOMAIN',
'VITE_APP_NAME',);
