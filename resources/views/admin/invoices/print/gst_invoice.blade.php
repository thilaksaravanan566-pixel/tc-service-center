    ...
    <div class="print-container max-w-4xl mx-auto bg-white p-12 shadow-2xl relative">
        ...
        <div class="flex justify-between items-start mb-8 border-b-2 pb-6 theme-border">
            ...
            <div class="text-right">
                <h2 class="text-4xl font-black uppercase theme-text mb-2">TAX INVOICE</h2>
        ...
        <div class="grid grid-cols-2 gap-10 mb-8 w-full border border-gray-200 rounded-lg overflow-hidden">
            <div class="p-4 bg-gray-50 border-r border-gray-200">
                ...
                @if($invoice->customer_gst)
                    <p class="text-gray-600 font-medium mt-1 text-sm bg-indigo-50 px-2 py-0.5 inline-block rounded border border-indigo-100 mt-2">GSTIN: <span class="font-bold theme-text uppercase tracking-widest">{{ $invoice->customer_gst }}</span></p>
                @endif
            </div>
